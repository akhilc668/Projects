				...
				<div class="card">
					<div class="card-body">
						<form action="./student_update" method="post" enctype = "multipart/form-data">
							...
							<div class="form-group">
								Pincode: <input type="number" class="form-control" name="pincode" value="<%=s.getPincode() %>" required="required">
							</div>
							<div class="form-group">
								Nationality: <input type="text" class="form-control" name="nationality" value="<%=s.getNationality() %>" required="required">
							</div>
							<div class="form-group">
								Inter Percentage: <input type="number" step="any" class="form-control" name="inter" value="<%=s.getInter_percentage() %>" required="required">
							</div>
							<div class="form-group">
								SSC Percentage: <input type="number" step="any" class="form-control" name="ssc" value="<%=s.getSsc_percentage() %>" required="required">
							</div>
							<div class="form-group">
