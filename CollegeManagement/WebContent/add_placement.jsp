				...
				<div class="card">
					<div class="card-body">
						<form action="./add_placement" method="post">
							...
							<div class="form-group">
								Company Name: <input type="text" class="form-control" name="companyname" placeholder="Enter Comapny name" required="required">
							</div>
							<div class="form-group">
								package: <input type="number" class="form-control" name="package" placeholder="Enter Package" required="required">
							</div>
