...
<div class="container-fulid">
		<div class="row justify-content-center align-items-center"
			...
			<div class="col-4">
				<div class="card">
					<div class="card-body">
						<form action="./add_paper_publication" method="post" enctype = "multipart/form-data">
							...
							<div class="form-group">
								Published Date: <input type="date" class="form-control" name="date" placeholder="Enter the place of seminar" required="required">
							</div>
							<div class="form-group">
