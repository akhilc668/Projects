				...
				<div class="card">
					<div class="card-body">
						<form action="./add_seminar" method="post">
							...
							<div class="form-group">
								Format: <input type="radio" name="format" required="required"
									value="lecture">Lecture <input type="radio"
									name="format" required="required" value="seminar">Seminar
							</div>
							<div class="form-group">
								Date: <input type="date" class="form-control" name="date"
									placeholder="Enter the place of seminar" required="required">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								Place of Seminar: <input type="text" class="form-control"
									name="place_of_seminar"
									placeholder="Enter the place of seminar" required="required">
							</div>
