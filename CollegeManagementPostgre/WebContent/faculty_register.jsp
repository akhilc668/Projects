				...
				<div class="card">
					<div class="card-body">
						<form action="./faculty_register" method="post">
							...
							<div class="form-group">
								Subject: <input type="text" class="form-control" name="subject" placeholder="Enter Subject" required="required">
							</div>
							<div class="form-group">
							...
							<b>Already Registered?</b> <a href="faculty_login.jsp" class="btn btn-primary">Login</a>
							</center>
						</form>
					</div>
				</div>
