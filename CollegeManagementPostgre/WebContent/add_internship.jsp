...
<h1 align="center">Welcome to Add Internship Page</h1>
...
<div class="container-fulid">
		<div class="row justify-content-center align-items-center"
			...
			<div class="col-4">
				<div class="card">
					<div class="card-body">
						<form action="./add_internship" method="post" enctype = "multipart/form-data">
							...
							<div class="form-group">
								Duration: <input type="text" class="form-control" name="duration" placeholder="Enter duration" required="required">
							</div>
							<div class="form-group">
