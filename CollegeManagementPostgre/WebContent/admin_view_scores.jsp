...
<body>
	...
	<%@page
		import="com.pojo.student.StudentMarks,com.admin.ViewBean,java.util.*"%>
						...
						<form action="admin_view_scores.jsp" align="center">
							<div class="form-group">
								<label>Enter Student name :</label> <input type="text"
									...
									Year in Romans : </label> <input type="text" class="form-control"
									name="year" placeholder="Enter year"> <br> <input
